...
public class NoOrderException extends DAOException {
     ...
     * @param name      the name
     */
    public NoOrderException(String name) {
        super(name);
    }
     ...
     * @param name      the name
     */
    public NoOrderException(String message, String name) {
        super(message, name);
    }
     ...
     * @param name      the name
     */
    public NoOrderException(String message, Throwable cause, String name) {
     ...
     * @param name      the name
     */
    public NoOrderException(Throwable cause, String name) {
        super(cause, name);
    }
