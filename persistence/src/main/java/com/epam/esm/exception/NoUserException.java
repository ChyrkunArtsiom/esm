...
public class NoUserException extends DAOException {
     ...
     * @param name      the name
     */
    public NoUserException(String name) {
        super(name);
    }
     ...
     * @param name      the name
     */
    public NoUserException(String message, String name) {
        super(message, name);
    }
     ...
     * @param name      the name
     */
    public NoUserException(String message, Throwable cause, String name) {
     ...
     * @param name      the name
     */
    public NoUserException(Throwable cause, String name) {
        super(cause, name);
    }
