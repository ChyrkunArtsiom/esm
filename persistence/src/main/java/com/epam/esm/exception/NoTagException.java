...
/**
 * Thrown to indicate that {@link com.epam.esm.entity.Tag} object not found.
 */
public class NoTagException extends DAOException {
     ...
     * @param name      the name
     */
    public NoTagException(String name) {
        super(name);
    }
     ...
     * @param name      the name
     */
    public NoTagException(String message, String name) {
        super(message, name);
    }
     ...
     * @param name      the name
     */
    public NoTagException(String message, Throwable cause, String name) {
     ...
     * @param name      the name
     */
    public NoTagException(Throwable cause, String name) {
        super(cause, name);
    }
