...
/**
 * The template for indication that user name is blank.
 */
public class UserBlankUsernameTemplate implements ValidationTemplate {
    @Override
    public String getMessage(ErrorMessageManager manager) {
        return manager.getMessage("userBlankUsername");
    }
}
