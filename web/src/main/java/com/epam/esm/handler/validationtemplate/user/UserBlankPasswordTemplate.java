...
/**
 * The template for indication that user password is blank.
 */
public class UserBlankPasswordTemplate implements ValidationTemplate {
    @Override
    public String getMessage(ErrorMessageManager manager) {
        return manager.getMessage("userBlankPassword");
    }
}
